...
public class McSkillsChangeLevelEventUpImpl implements McSkillsChangeLevelEvent.Up {
    ...
    public McSkillsChangeLevelEventUpImpl(Player player, int originalLevel, int level, long remainingExperience, Cause cause) {
        this.player = player;
        this.cause = cause;
