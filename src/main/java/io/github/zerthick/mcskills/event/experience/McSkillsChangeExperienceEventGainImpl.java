...
public class McSkillsChangeExperienceEventGainImpl implements McSkillsChangeExperienceEvent.Gain {
    ...
    public McSkillsChangeExperienceEventGainImpl(Player player, long experience, Cause cause) {
        this.player = player;
        this.cause = cause;
